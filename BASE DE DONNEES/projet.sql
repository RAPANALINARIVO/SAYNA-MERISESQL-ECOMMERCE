...
CREATE TABLE `categorie` (
  ...
  `descriptionCat` varchar(255) NOT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE `commande` (
  ...
  CONSTRAINT `commande_ibfk_2` FOREIGN KEY (`produit_id`) REFERENCES `produit` (`id`),
  CONSTRAINT `commande_ibfk_3` FOREIGN KEY (`user_id`) REFERENCES `utilisateur` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `produit` (
  ...
  `prix` int NOT NULL,
  `stockDisponible` varchar(255) DEFAULT NULL,
...
-- Dump completed on 2023-09-11  7:07:08
